...
function PrintContractsPage(){
 ...
 async function load(){
  const [c,t]=await Promise.all([
   supabase.from('student_contracts').select('*,students(student_number,bus_number,bus_round,profiles!students_profile_id_fkey(full_name),classes(name,section))').order('id',{ascending:false}),
